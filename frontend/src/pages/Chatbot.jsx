...
export default function Chatbot() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      <Sidebar />
      <div className="flex-1 p-6 md:p-8 max-w-5xl flex flex-col h-screen">
        {/* Header */}
        <div className="flex items-center justify-between pb-4 border-b border-slate-200 shrink-0">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Personalized advice tuned to {activeData?.targetJobTitle || 'Junior Backend Developer'} ({activeData?.readinessScore || 72}% match)
            </p>
          </div>
          <Link
            to="/dashboard"
            className="text-xs font-bold text-blue-600 hover:text-blue-700 inline-flex items-center gap-1 bg-white border border-slate-200 px-3 py-1.5 rounded-lg shadow-xs hover:border-blue-300"
          >
